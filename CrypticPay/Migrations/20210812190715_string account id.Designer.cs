...
namespace CrypticPay.Migrations
{
    ...
    [Migration("20210812190715_string account id")]
    partial class stringaccountid
    {
            ...
            modelBuilder.Entity("CrypticPay.Data.Wallet", b =>
                {
                    ...
                    b.Property<string>("CrypticPayUserForeignKey")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("CrypticPayUserForeignKey")
                        .IsUnique()
                        .HasFilter("[CrypticPayUserForeignKey] IS NOT NULL");
            ...
            modelBuilder.Entity("CrypticPay.Data.Wallet", b =>
                {
                    b.HasOne("CrypticPay.Areas.Identity.Data.CrypticPayUser", "Owner")
                        ...
                        .HasForeignKey("CrypticPay.Data.Wallet", "CrypticPayUserForeignKey");
                });
