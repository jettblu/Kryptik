...
namespace CrypticPay.Areas.Identity.Pages.Account.Manage
{
    ...
    {
        private readonly CrypticPay.Data.CrypticPayFriendshipContext _contextFriends;
        ...
        public DeletePersonalDataModel(
            CrypticPay.Data.CrypticPayFriendshipContext contextFriends,
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            // add error handling for friends deletion
            var deletionResult = await Utils.RemoveUserFriendships(_contextFriends, _userManager, userId);
